...
public class LoginPageObject extends BaseClass {
	 ...
	 * @CacheLookup
	 * 
	 * @FindBys({ @FindBy(id = "email"), @FindBy(xpath = "//input[@placeholder" +
	 * "='Email address or phone number']"),
	 * 
	 * @FindBy(xpath = "//input[@name='email']") }) private WebElement txtEmail;
	 * 
	 * @CacheLookup
	 * 
	 * @FindBy(id = "pass") private WebElement txtPass;
	 * 
	 * // @FindBy(xpath="//button[text()='Log in']") // private WebElement btnLogin;
	 * 
	 * @CacheLookup
	 * 
	 * @FindAll({ @FindBy(xpath = "//button[text()='Log in']"), @FindBy(xpath =
	 * "//button[@value='']")
	 * 
